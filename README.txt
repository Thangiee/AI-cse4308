...
Note: to execute the jar on omega, jdk6 need to be set as default jdk when executing step 4.
      Pre-included naive_bayes.jar is jdk 6 compatible
...
5. After finishing, it should create a new naive_bayes.jar in the same directory.

6. To execute:
    java -jar naive_bayes.jar <training_file> <test_file> histograms <number>
    java -jar naive_bayes.jar <training_file> <test_file> gaussians
    java -jar naive_bayes.jar <training_file> <test_file> mixtures <number>
